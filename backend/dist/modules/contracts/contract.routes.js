...
async function contractRoutes(app) {
    ...
    app.get('/', { preHandler: [(0, auth_1.requirePermission)('CONTRACT_READ')] }, contractController.getAll);
    app.get('/:id', { preHandler: [(0, auth_1.requirePermission)('CONTRACT_READ')] }, contractController.getById);
    ...
    app.patch('/:id', { preHandler: [(0, auth_1.requirePermission)('CONTRACT_UPDATE')] }, contractController.update);
}
