...
async function employeeRoutes(app) {
    ...
    app.get('/', { preHandler: [(0, auth_1.requirePermission)('EMPLOYEE_READ')] }, employeeController.getAll);
    app.get('/:id', { preHandler: [(0, auth_1.requirePermission)('EMPLOYEE_READ')] }, employeeController.getById);
